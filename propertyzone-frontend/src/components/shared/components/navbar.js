            ...
            <div className="row">
              <div className="col-md-7">
                <div className="ltn__top-bar-menu">
                  <ul>
                    <li>
                      <a href="mailto:aliimran744@gmail.com">
                        <i className="icon-mail" /> aliimran744@gmail.com
                      </a>
                    </li>
                    <li>
                      <a href="locations.html">
                        <i className="icon-placeholder" /> Faisal Heights, FSD
                      </a>
                    </li>
                  </ul>
                </div>
                    ...
                    <div className="ltn__main-menu">
                      <ul>
                        ...
                        {links?.map((link, index) => (
                          <li key={index} onMouseEnter={() => setHovered(index)} onMouseLeave={() => setHovered(null)}
                            style={{color: hovered === index ? "#ff5a3c" : "white", transition: "color 0.1s",}}>
