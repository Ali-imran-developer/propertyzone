			...
			<div className="ltn__header-top-area section-bg-6 top-area-color-white---">
				...
				<div className="row">
					...
					<div className="ltn__top-bar-menu">
						<ul>
						<li><a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you"><i className="icon-mail" />aliimran744@gmail.com</a></li>
						<li><a href="locations.html"><i className="icon-placeholder" />Faisal Heights, FSD</a></li>
						</ul>
					</div>
					</div>
